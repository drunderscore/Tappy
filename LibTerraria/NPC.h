...
public:
    ...
    bool direction_y() const
    { return m_direction_y; }

    void set_direction_y(bool value)
    { m_direction_y = value; }
    ...
    bool sprite_direction() const
    { return m_sprite_direction; }

    void set_sprite_direction(bool value)
    { m_sprite_direction = value; }

    const Optional<u8>& scaled_for_this_many_players() const
    { return m_scaled_for_this_many_players; }

    Optional<u8>& scaled_for_this_many_players()
    { return m_scaled_for_this_many_players; }

    bool spawned_from_statue() const
    { return m_spawned_from_statue; }

    void set_spawned_from_statue(bool value)
    { m_spawned_from_statue = value; }

    const Optional<float> strength_multiplier() const
    { return m_strength_multiplier; }

    Optional<float> strength_multiplier()
    { return m_strength_multiplier; }

    const Optional<u8> release_owner() const
    { return m_release_owner; }

    Optional<u8> release_owner()
    { return m_release_owner; }
