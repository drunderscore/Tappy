...
void generate_tile_models(const JsonArray& items)
{
    ...
    items.for_each([&](auto& value) {
        ...
        out("{{\"{}\", {}, {}, {}, {}", value_obj.get("internalName").as_string(),
            value_obj.get("frameImportant").to_bool(), value_obj.get("tileSolid").to_bool(),
            value_obj.get("tileSolidTop").to_bool(), value_obj.get("stone").to_bool());
...
void generate_prefix_models(const JsonArray& items)
{
    ...
    items.for_each([&](auto& value) {
        ...
        {
            auto& value_obj = value.as_object();
            out("{{\"{}\", \"{}\"", value_obj.get("englishName").as_string(),
                value_obj.get("internalName").as_string());
        }
        if (count < items.size() - 1)
            outln("}},");
        else
...
void generate_tile_object_models(const JsonArray& items)
{
    ...
    items.for_each([&](auto& value) {
        ...
        else
        {
            ...
            out("{{{}, {}, {}, {{{}, {}}}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {{",
                value_obj.get("width").to_i32(), value_obj.get("height").to_i32(), value_obj.get("type").to_i32(),
                origin.get("X").to_i32(), origin.get("Y").to_i32(), value_obj.get("direction").to_i32(),
                value_obj.get("styleWrapLimit").to_i32(), value_obj.get("styleMultiplier").to_i32(),
                value_obj.get("randomStyleRange").to_i32(), value_obj.get("styleHorizontal").as_bool(),
                value_obj.get("styleLineSkip").to_i32(), value_obj.get("coordinateWidth").to_i32(),
                value_obj.get("coordinateFullWidth").to_i32(), value_obj.get("coordinateFullHeight").to_i32(),
                value_obj.get("coordinatePadding").to_i32(), value_obj.get("style").to_i32());
